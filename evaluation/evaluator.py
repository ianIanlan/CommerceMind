...
DEFAULT_INTENT_CASES: List[IntentTestCase] = [
    ...
    IntentTestCase("帮我取消订单",               "order_cancel"),
    IntentTestCase("你们服务太差了！",            "complaint"),
    IntentTestCase("应用一直报500错误",           "technical_crash"),
    IntentTestCase("为什么扣了两次款？",          "duplicate_payment"),
    ...
    IntentTestCase("退款多久到账？",              "refund_status"),
    IntentTestCase("登录一直报401",               "technical_login"),
    IntentTestCase("收到的包裹少了一件商品",       "damaged_item"),
    IntentTestCase("订单地址填错了，能修改吗？",   "address_change"),
    IntentTestCase("这个商品还有黑色库存吗？",     "product_query"),
]

DEFAULT_DIALOG_CASES: List[Dict[str, Any]] = [
    {"question": "订单 ORD-10002 的物流到哪里了？", "user_id": "demo-user"},
    {"question": "应用登录一直报错 401"},
    {"question": "订单 ORD-10005 为什么扣了两次款？", "user_id": "demo-user"},
    {"question": "订单 ORD-10002 已经发货，还能修改地址吗？", "user_id": "demo-user"},
    {"turns": ["你好，我想退款", "订单号是 ORD-10001", "请说明下一步，但不要直接替我执行"], "user_id": "demo-user"},
]
